...
<section id="edit-reporteEscaneoTag" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${reporteEscaneoTagInstance?.id}" />
		<g:hiddenField name="version" value="${reporteEscaneoTagInstance?.version}" />
		<fieldset class="form">
