...
<section id="edit-configuracionBytes" class="first">
	...
	<g:form method="post" class="form-horizontal"  enctype="multipart/form-data">
		<g:hiddenField name="id" value="${configuracionBytesInstance?.id}" />
		<g:hiddenField name="version" value="${configuracionBytesInstance?.version}" />
		<fieldset class="form">
