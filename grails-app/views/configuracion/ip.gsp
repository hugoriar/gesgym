...
<g:form action="cambiaAdaptador" class="form-horizontal" >
    <fieldset class="form">
        <div class="control-group fieldcontain ${hasErrors(bean: productoInstance, field: 'categoria', 'error')} required">
            <label for="categoria" class="control-label"><g:message code="producto.categoria.label" default="Adaptadores" /><span class="required-indicator">*</span></label>
            <div class="controls">
                <g:select id="networkInterfaces" name="adaptador" from="${networkInterfaces}" required="" value="${networkInterfaces}"/>
                <span class="help-inline">${hasErrors(bean: productoInstance, field: 'categoria', 'error')}</span>
            </div>
        </div>
    </fieldset>
    <div class="form-actions">
        <g:submitButton name="cambiaAdaptador" class="btn btn-primary" value="${message(code: 'default.button.cambiar.label', default: 'Cambiar')}" />
        <button class="btn" type="reset"><g:message code="default.button.reset.label" default="Reset" /></button>
    </div>
</g:form>

	<section id="info">
        <p><i class="icon-list"></i><g:link controller="userSocio" action="arreglaFechas" params=""> Arregla Fechas</g:link></p>
        %{--<p><i class="icon-plus-sign"></i><g:link controller="userSocio" action="cambiarEstadosBatch"> Expirar membresías</g:link></p>--}%
        %{--<p><i class="icon-plus-sign"></i><g:link controller="configuracion" action="procesaYOrdenaMatriculas"> Procesa y Ordena Matrículas</g:link></p>--}%
