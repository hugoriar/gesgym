<%@ page import="org.control.fichaMedica.Profesional" %>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: profesionalInstance, field: 'especializacionProfesional', 'error')} ">
				...
				<div class="controls">
					<g:select id="especializacionProfesional" name="especializacionProfesional.id" from="${org.control.Especializacion.list()}" optionKey="id" value="${profesionalInstance?.especializacionProfesional?.id}" class="many-to-one" noSelection="['null': '']"/>
