...
<%--		</g:link>--%>
			...
			<span class="button"><g:actionSubmit class="btn btn-danger" controller="userSocio" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}"/></span>
		</g:form>
