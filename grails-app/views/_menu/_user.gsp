    ...
    <li class="dropdown dropdown-btn">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="form-container">
                    <form action="${postUrl}" method="post" accept-charset="UTF-8">
                        <input style="margin-bottom: 15px;" type="text" placeholder="Usuario" id="username" name="j_username">
                        <input style="margin-bottom: 15px;" type="password" placeholder="Password" id="password" name="j_password">
                        <input style="float: left; margin-right: 10px;" type="checkbox" name="remember-me" id="remember-me" value="1">
                        <label class="string optional" for="user_remember_me"> No cerrar sesión</label>
        ...
        <sec:ifLoggedIn>
            ...
            <a class="dropdown-toggle" role="button" data-toggle="dropdown" data-target="#" href="#">
                ...
                <span class="icon-user icon-large icon-white"></span>
                ${sec.loggedInUserInfo(field: 'username')}
                %{--<g:message code="default.user.unknown.label" default="Guest"/> --}%
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu" role="menu">
                %{--TODO: Only show menu items based on permissions--}%
                <li class=""><a href="${createLink(controller: 'userSocio', action: 'show', id: sec.loggedInUserInfo(field: 'id'))}">
                    <span class="icon-user"></span>
