<%@ page import="org.gym.LogCambiosDeEstado" %>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: logCambiosDeEstadoInstance, field: 'modalidad', 'error')} required">
				...
				<div class="controls">
					<g:select id="modalidad" name="modalidad.id" from="${org.gym.Modalidad.list()}" optionKey="id" required="" value="${logCambiosDeEstadoInstance?.modalidad?.id}" class="many-to-one"/>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: logCambiosDeEstadoInstance, field: 'socio', 'error')} required">
				...
				<div class="controls">
					<g:select id="socio" name="socio.id" from="${org.gym.UserSocio.list()}" optionKey="id" required="" value="${logCambiosDeEstadoInstance?.socio?.id}" class="many-to-one"/>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: logCambiosDeEstadoInstance, field: 'estadoAntiguo', 'error')} required">
				...
				<div class="controls">
					<g:select id="estadoAntiguo" name="estadoAntiguo.id" from="${org.gym.EstadoMembresia.list()}" optionKey="id" required="" value="${logCambiosDeEstadoInstance?.estadoAntiguo?.id}" class="many-to-one"/>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: logCambiosDeEstadoInstance, field: 'estadoNuevo', 'error')} required">
				...
				<div class="controls">
					<g:select id="estadoNuevo" name="estadoNuevo.id" from="${org.gym.EstadoMembresia.list()}" optionKey="id" required="" value="${logCambiosDeEstadoInstance?.estadoNuevo?.id}" class="many-to-one"/>
