<%@ page import="org.control.fichaMedica.CondicionMedica" %>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: condicionMedicaInstance, field: 'condicion', 'error')} ">
				...
				<div class="controls">
					<g:textField name="condicion" value="${condicionMedicaInstance?.condicion}" readonly="readonly" style="background-color: #ffffff !important;"/>
...
--}%
			...
			<div class="control-group fieldcontain ${hasErrors(bean: condicionMedicaInstance, field: 'medicamento', 'error')} ">
				...
				<div class="controls">
					<g:textField name="medicamento" value="${condicionMedicaInstance?.medicamento}" readonly="readonly" style="background-color: #ffffff !important;"/>
					<span class="help-inline">${hasErrors(bean: condicionMedicaInstance, field: 'medicamento', 'error')}</span>
				</div>
			</div>

<g:render template="formProfesional"/>
